...
/*
    Se pregunta al usuario por una entrada y se crea un bucle que 
    se repetirá hasta que dicha entrada sea 0.

    Si la entrada es menor a 1 o mayor a 30 se muestra un mensaje
    de error y se repite el bucle.

    Si la entrada es valida:
        - Se guarda la entrada para mostrarla posteriormente.
        - Se crea un bucle que se repetirá hasta que la entrada
          sea indivisible.
        - Se divide la entrada entre dos y el resto será el
          primer caracter binario.
        - Se divide la entrada entre dos para volver a calcular
          el resto.
        - Se multiplica el caracter binario por la potencia de
          10 que corresponda a la posicion del caracter actual
          (1 para la primera posición, 10 para la segunda, 100
           para la tercera...).
        - Se muestra el mensaje con el número binario
