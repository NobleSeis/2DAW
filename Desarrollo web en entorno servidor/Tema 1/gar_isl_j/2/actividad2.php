...
<nav class="mb-5" style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
    <ol class="breadcrumb bg-light p-3">
        ...
        <li class="breadcrumb-item active">Actividad 2</li>
    </ol>
</nav>
...
<div class="tab-content my-5">
    ...
    <div class="tab-pane container active" id="windows">
        ...
        <img class="img-fluid mx-auto d-block" src="assets/img/windows-1.png" alt="Instalador de XAMPP">
        ...
        <img class="img-fluid mx-auto d-block" src="assets/img/windows-2.png" alt="Instalador de XAMPP">
        <p class="my-5">
        ...
        <img class="img-fluid mx-auto d-block" src="assets/img/windows-3.png" alt="Instalador de XAMPP">
        <p class="my-5">
        ...
        <img class="img-fluid mx-auto d-block" src="assets/img/windows-4.png" alt="Instalador de XAMPP">
        <p class="my-5">
        ...
        <img class="img-fluid mx-auto d-block" src="assets/img/windows-5.png" alt="Instalador de XAMPP">
    </div>
    ...
    <div class="tab-pane container fade" id="linux">
        ...
        <img class="img-fluid mx-auto d-block" src="assets/img/linux-1.png" alt="Instalador de XAMPP">
        <p class="my-5">
        ...
        <img class="img-fluid mx-auto d-block" src="assets/img/linux-2.png" alt="Instalador de XAMPP">
        <p class="my-5">
        ...
        <img class="img-fluid mx-auto d-block" src="assets/img/linux-3.png" alt="Instalador de XAMPP">
        ...
        <img class="img-fluid mx-auto d-block" src="assets/img/linux-4.png" alt="Instalador de XAMPP">
        <p class="my-5">Y listo, una vez se completa la instalación podemos abrir el panel de control de XAMPP</p>
        <img class="img-fluid mx-auto d-block" src="assets/img/linux-5.png" alt="Instalador de XAMPP">
    </div>
    <hr class="my-5">
    <div>
        ...
        <img class="img-fluid mx-auto d-block" src="assets/img/php-1.png" alt="Hola mundo PHP">
        <p class="my-5">
        ...
        <img class="img-fluid mx-auto d-block" src="assets/img/php-2.png" alt="Hola mundo PHP">
        <p class="my-5">
